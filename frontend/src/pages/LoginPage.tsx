    ...
    <div className="flex min-h-svh items-center justify-center bg-background bauhaus-dots px-4 py-16">
      <div className="w-full max-w-sm">
        <div className="mb-8 flex flex-col items-center gap-2 text-center">
          <Logo size="lg" />
          <p className="font-bold uppercase tracking-widest text-black/60">Sign in to your team account</p>
        </div>

        <Card decoration="circle" decorationColor="blue">
        ...
        <p className="mt-6 text-center text-sm font-medium">
          No account?{' '}
          <Link to="/register" className="font-bold underline decoration-2 underline-offset-2 hover:text-primary-blue">
            Create one
          </Link>
        </p>
      </div>
